...
public class Reconhecimento {
	...
	public static void reconhecer() throws Exception {

		System.setProperty("java.awt.headless", "false");
		double thresholdConfianca = 4051.612605355683; // Defina o threshold de confiança adequado para o seu caso

		OpenCVFrameConverter.ToMat converteMat = new OpenCVFrameConverter.ToMat();
		OpenCVFrameGrabber camera = new OpenCVFrameGrabber(1);
		String[] pessoas = { "", "Iuri", "Iuri", "Joice", "Samuel" , "Laressa"};
		camera.start();
